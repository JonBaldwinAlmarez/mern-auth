		...
		<div className="flex items-center justify-center min-h-screen bg-linear-to-br from-blue-200 to-purple-400">
				...
				>
					...
					<div className="flex items-center mb-4 w-full gap-3 px-5 py-2.5 rounded-full bg-[#333A5C]">
						...
						<input
							...
							value={email} // The variable email stores the current value of the input.
							onChange={(e) => setEmail(e.target.value)}
							required
						/>
					</div>
					<button className="w-full py-3 bg-linear-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3 cursor-pointer">
						Submit
					</button>
				</form>
			)}
			...
			{!isOtpSubmitted && isEmailSent && (
				...
				>
					...
					<p className="text-center mb-6 text-indigo-300">
						Enter 6 digit codes sent to your email
					</p>
				...
				>
					...
					<div className="flex items-center mb-4 w-full gap-3 px-5 py-2.5 rounded-full bg-[#333A5C]">
						...
						<input
							...
							value={newPassword} // The variable email stores the current value of the input.
